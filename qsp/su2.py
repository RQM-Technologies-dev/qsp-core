...
def normalize_quaternion(value: Union[Quaternion, Iterable[float]]) -> Quaternion:
    """Return a normalized quaternion from a quaternion or four real values."""
    return _coerce_quaternion(value).normalize()


def is_unit_quaternion(value: Union[Quaternion, Iterable[float]], *, tolerance: float = 1e-9) -> bool:
...
def quaternion_to_su2(value: Union[Quaternion, Iterable[float]]) -> Matrix2x2:
...
def _coerce_quaternion(value: Union[Quaternion, Iterable[float]]) -> Quaternion:
